  ...
  (props, ref) => {
    return (
      <svg
        ...
        {...props}
        ref={ref}>
        <path fill={icon} d={'M10 12L18 6V18L10 12Z'} clipRule={'evenodd'} fillRule={'evenodd'} />
        <path fill={icon} d={'M8 18C9.1 18 10 17.1 10 16V8C10 6.9 9.1 6 8 6C6.9 6 6 6.9 6 8V16C6 17.1 6.9 18 8 18Z'} />
      </svg>
    )
  }
)
  ...
  (props, ref) => {
    return (
      <svg
        ...
        {...props}
        ref={ref}>
        <path fill={icon} d={'M14 12L6 6V18L14 12Z'} clipRule={'evenodd'} fillRule={'evenodd'} />
        <path
          fill={icon}
  ...
  return (
    <svg
      ...
      <path
        ...
        fillRule={'evenodd'}
      />
      <path fill={icon} d={'M18 3.9458L22.8868 7.00005L18 10.0543V3.9458Z'} clipRule={'evenodd'} fillRule={'evenodd'} />
      <path fill={icon} d={'M18 13.9458L22.8868 17L18 20.0543V13.9458Z'} clipRule={'evenodd'} fillRule={'evenodd'} />
    </svg>
  )
})
...
export const VolumeDownIcon: React.FunctionComponent<React.SVGProps<SVGSVGElement>> = React.forwardRef((props, ref) => {
  return (
    <svg
      ...
      {...props}
      ref={ref}>
      <path fill={icon} d={'M9 8H5V16H9L15 21V3L9 8Z'} />
      <path fill={icon} d={'M17 15.46C18.2 14.77 19 13.48 19 12C19 10.52 18.2 9.23004 17 8.54004'} />
    </svg>
  )
})
...
export const VolumeUpIcon: React.FunctionComponent<React.SVGProps<SVGSVGElement>> = React.forwardRef((props, ref) => {
  return (
    <svg
      ...
      {...props}
      ref={ref}>
      <path fill={icon} d={'M7 8H3V16H7L13 21V3L7 8Z'} />
      <path fill={icon} d={'M15 19.75C18.45 18.86 21 15.73 21 12C21 8.27 18.45 5.14 15 4.25'} />
      <path fill={icon} d={'M15 15.46C16.2 14.77 17 13.48 17 12C17 10.52 16.2 9.23004 15 8.54004'} />
    </svg>
  )
})
